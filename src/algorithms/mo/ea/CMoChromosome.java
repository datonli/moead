...
public class CMoChromosome extends MoChromosome implements Serializable {
	...
	public void setRealGenes(double[] realGenes) {
		this.realGenes = realGenes;
	}

	public static int getIdCx() {
		return id_cx;
	}

	public static int getIdMu() {
		return id_mu;
	}
	...
	public String toString() {
		...
		// 重写
		String str = "";
		str += this.fitnessValue + "," + this.objectivesValue[0] + ","
				+ this.objectivesValue[1] + "," + this.objectivesEI[0] + ","
				+ this.objectivesEI[1] + ","
				+ this.estimatedObjectiveDevitation[0] + ","
				+ this.estimatedObjectiveDevitation[1] + ","
				+ this.estimatedObjectiveValue[0] + ","
				+ this.estimatedObjectiveValue[1];
		for (int i = 0; i < this.realGenes.length; i++)
			str = str + "," + this.realGenes[i];
		return str;
	}
